...
int vec_bounds_check(vector_t* vec, obj_t* ptr);//check a ptr to make sure it's within the vector and aligned with an ptr_pod_tect 
...
obj_t* vec_insert(vector_t* vec, obj_t* loc, unsigned idx);
